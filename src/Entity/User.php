 ...
 * @UniqueEntity(
 *     fields={"email"},
 *     message="Un autre utilisateur s'est déjà inscrit avec cette adresse, merci de la modifier"
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\Length(min=100, minMessage="Votre description doit faire avoir 100 caractères minimun")
     */
    private $description;
