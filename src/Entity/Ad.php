 ...
 * @UniqueEntity(
 *  fields={"title"},
 *   message="une autre annonce existe déjà avec ce titre, merci de le modifier")
 */
class Ad
{
    /**
    ...
    /**
     * @ORM\Column(type="text")
     *  @Assert\Length(min=100, minMessage="Votre description ne peut pas avoir moins de  100 caractères")
     */
    private $content;
    ...
    /**
     * Permet d'obtenir la moyenne globales des notes de cette annonce
     *
     * @return float
     */
    public function getAvgRatings()
    {
        //calculer la somme des nottations
    ...
    public function getNotAvailableDays()
    {
        ...
        foreach ($this->bookings as $booking) {
            //Calcul des jours entre la date d'arrivée et de départ
            $resultat = range(
